$("document").ready(function(){
    ...
    window.onscroll=function()
    {
        ...
        {
            $("#navbarId").css( {"background-color":"rgba(0,0,0,0.7)" , "z-index": "999" } ) ;
        }
    ...
    // when click on any link of navbar , go to section
    $(".linksContainer li a").click(function(){
        $("html,body").animate({
    ...
    /* ++++++++++++++++++++++++++++++ navbar : links part ++++++++++++++++++++++++++++++ */
    // ---------------------- navbar : when click on menubar icon , we will appear links -----------------------
    $("#linksId").click( function(){
        /* والعكس صحيح header ويخفي ال navbar هيظهر لي ال menubar icon لما اضغط علي ال  */
        $(".linksContainer").fadeToggle();
        $(".intro").fadeToggle();
    });
	/* ########################################## our work ##################################### */
    // show hidden items 
	...
	function checkClients()
	{
		/*  المختصرة if مكنش كده هيظهره هنستخدم دالة left arrow فهخفي ال active كان واخد كلاس client لو اول */
		 $(".clients:first").hasClass("active") ? leftArrow.fadeOut(10) : leftArrow.fadeIn(10) ;
		/*  المختصرة if مكنش كده هيظهره هنستخدم دالة right arrow فهخفي ال active كان واخد كلاس client لو اخر */
		 $(".clients:last").hasClass("active") ? rightArrow.fadeOut(10) : rightArrow.fadeIn(10) ;
	}
	...
	$(".testim	i").click(function(){
        ...
        if( $(this).hasClass("fa-chevron-right") )
       {
          ...
          */
            $(".testim .active").fadeOut(10, function(){
